...
@Component
@StepScope
public class InsertaArchivoInicialProcessor extends ArchivoProcessor
		implements ItemProcessor<RegistroDTO, DetalleRegistroDTO> {

	protected final static Logger logger = LoggerFactory.getLogger(InsertaArchivoInicialProcessor.class);
